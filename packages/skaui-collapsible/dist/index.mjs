...
var Collapsible = (props) => {
  ...
  const [open, setOpen] = React3.useState(_open);
  const [height, setHeight] = React3.useState(
    open ? void 0 : 0
  );
  ...
  }, /* @__PURE__ */ React3.createElement("span", null, title), /* @__PURE__ */ React3.createElement("span", null, /* @__PURE__ */ React3.createElement(FiChevronDown, {

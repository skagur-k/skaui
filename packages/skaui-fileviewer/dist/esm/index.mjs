...
var Clipboard = function (_a) {
    ...
    return (jsxRuntime.exports.jsx("div", __assign$1({ className: clsx(className, styles$1.wrapper) }, { children: jsxRuntime.exports.jsx(AnimatePresence, __assign$1({ exitBeforeEnter: true }, { children: isCopied ? (jsxRuntime.exports.jsx(motion.button, __assign$1({ variants: variants, initial: 'hidden', animate: 'show', exit: 'hidden', transition: { duration: 0.2 } }, { children: jsxRuntime.exports.jsx(FiCheck, { className: clsx(styles$1.icons, styles$1.copied) }) }), 'copied')) : (jsxRuntime.exports.jsx(motion.button, __assign$1({ onClick: handleCopy, variants: variants, initial: 'hidden', animate: 'show', exit: 'hidden', transition: { duration: 0.2 } }, { children: jsxRuntime.exports.jsx(FiClipboard, { className: clsx(styles$1.icons, styles$1.clipboard) }) }), 'clipboard')) })) })));
};
...
var FileContent = function (_a) {
    ...
    return (jsxRuntime.exports.jsx("div", __assign$1({ className: styles.filecontentWrapper }, { children: jsxRuntime.exports.jsx(AnimatePresence, __assign$1({ exitBeforeEnter: true }, { children: jsxRuntime.exports.jsxs(motion.div, __assign$1({ initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: {
...
var Folder = React.memo(function (_a) {
    ...
    return (jsxRuntime.exports.jsx(FileContextProvider, __assign$1({ value: 1 + depth }, { children: jsxRuntime.exports.jsxs("li", __assign$1({ tabIndex: 0, onKeyDown: onKeyDown, className: clsx('treeview-folder', {
                'treeview-folder-open': isExpanded || open,
                        ...
                        (isExpanded && (jsxRuntime.exports.jsx(motion.ul, __assign$1({ initial: { height: 0 }, animate: { height: 'auto' }, exit: { height: 0 }, transition: { duration: 0.1, ease: 'linear' }, ref: ref, className: 'treeview-folder-children overflow-hidden' }, { children: sluggedChildren })))) })] })) })));
});

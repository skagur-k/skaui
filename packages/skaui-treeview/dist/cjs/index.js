...
var TreeContext = React.createContext(0);
var TreeContextProvider = TreeContext.Provider;
var useTree = function () { return React.useContext(TreeContext); };
...
var TreeView = React__default["default"].memo(function (_a) {
...
var Folder = React__default["default"].memo(function (_a) {
    ...
    var depth = useTree();
    var _c = React__default["default"].useState(defaultOpen), isOpen = _c[0], setIsOpen = _c[1];
...
var File = React__default["default"].memo(function (_a) {
    ...
    var depth = useTree();
    var ref = React__default["default"].useRef(null);
    var selected = React__default["default"].useState(isSelected)[0];
    var iconClone = null;
    if (icon) {

...
import React__default, { createContext, useContext, useLayoutEffect, useEffect, useState, useRef, useCallback, useMemo, forwardRef, createElement, cloneElement, Children, isValidElement } from 'react';
...
var TreeContext = createContext(0);
var TreeContextProvider = TreeContext.Provider;
var useTree = function () { return useContext(TreeContext); };
...
var css_248z = ".TreeView-module_treeview__Og3UI {\n\n    display: flex;\n\n    flex-direction: column;\n\n    list-style-type: none;\n\n    gap: 0px;\n\n    font-size: 0.875rem;\n\n    line-height: 1.25rem;\n\n    transition-property: all;\n\n    transition-timing-function: cubic-bezier(0.4, 0, 0.2, 1);\n\n    transition-duration: 150ms;\n\n    width: -webkit-fit-content;\n\n    width: -moz-fit-content;\n\n    width: fit-content;\n\n    min-width: 250px\n}\n\n.TreeView-module_title__o8WR- {\n\n    margin-bottom: 1rem;\n\n    font-size: 1rem;\n\n    line-height: 1.5rem;\n\n    font-weight: 700\n}\n";
var styles = {"treeview":"TreeView-module_treeview__Og3UI","title":"TreeView-module_title__o8WR-"};
styleInject(css_248z);

var TreeView = React__default.memo(function (_a) {
    var children = _a.children, title = _a.title;
    return (
    // <FocusScope>
    jsxRuntime.exports.jsxs("div", __assign$2({ className: styles.treeview }, { children: [title && jsxRuntime.exports.jsx("div", __assign$2({ className: styles.title }, { children: title })), children] }))
    // </FocusScope>
    );
});
TreeView.displayName = 'SKA UI - TreeView';
var Folder = React__default.memo(function (_a) {
    var children = _a.children, name = _a.name, open = _a.open, _b = _a.defaultOpen, defaultOpen = _b === void 0 ? false : _b;
    var depth = useTree();
    var _c = React__default.useState(defaultOpen), isOpen = _c[0], setIsOpen = _c[1];
    ...
    return (jsxRuntime.exports.jsx(TreeContextProvider, __assign$2({ value: 1 + depth }, { children: jsxRuntime.exports.jsxs("li", __assign$2({ tabIndex: 0, onKeyDown: onKeyDown, className: clsx('treeview-folder', {
                'treeview-folder-open': isOpen || open,
            }) }, { children: [jsxRuntime.exports.jsxs("a", __assign$2({ className: clsx('treeview-folder-label'), title: name, onClick: function () { return setIsOpen(function (open) { return !open; }); } }, { children: [Array.from(Array(depth)).map(function (_e, i) {
                            return (jsxRuntime.exports.jsx("span", { className: 'treeview-indent treeview-indent-folder' }, i));
                        }), jsxRuntime.exports.jsxs("div", __assign$2({ className: 'treeview-folder-label' }, { children: [jsxRuntime.exports.jsx("span", __assign$2({ className: clsx('treeview-folder-label-status treeview-icons', {
                                        'treeview-folder-label-status-disabled': open,
                                    }) }, { children: open || isOpen ? (jsxRuntime.exports.jsx(AiOutlineMinusSquare, { className: 'align-middle' })) : (jsxRuntime.exports.jsx(AiOutlinePlusSquare, {})) })), jsxRuntime.exports.jsx("span", __assign$2({ className: 'treeview-folder-label-icon' }, { children: jsxRuntime.exports.jsx(BsFolder, { className: 'treeview-icons' }) })), jsxRuntime.exports.jsx("span", __assign$2({ className: 'treeview-folder-label-name' }, { children: name }))] }))] })), jsxRuntime.exports.jsx(AnimatePresence, { children: open ||
                        (isOpen && (jsxRuntime.exports.jsx(motion.ul, __assign$2({ initial: { height: 0 }, animate: { height: 'auto' }, exit: { height: 0 }, transition: { duration: 0.1, ease: 'linear' }, ref: ref, className: 'treeview-folder-children overflow-hidden' }, { children: children })))) })] })) })));
});
Folder.displayName = 'SKA UI - TreeView/Folder';
var File = React__default.memo(function (_a) {
    var name = _a.name, active = _a.active, isSelected = _a.isSelected, icon = _a.icon;
    var depth = useTree();
    var ref = React__default.useRef(null);
    var selected = React__default.useState(isSelected)[0];
    var iconClone = null;
    if (icon) {
        iconClone = React__default.cloneElement(icon, {
            className: 'treeview-icons',
        });
    }
    return (jsxRuntime.exports.jsxs("li", __assign$2({ ref: ref, tabIndex: 0, className: clsx('treeview-file', {
            'treeview-file-active': active,
            'treeview-file-selected': selected,
        }) }, { children: [jsxRuntime.exports.jsx("a", __assign$2({ title: name }, { children: Array.from(Array(depth)).map(function (_e, i) {
                    return (jsxRuntime.exports.jsx("span", { className: 'treeview-indent treeview-indent-file' }, i));
                }) })), jsxRuntime.exports.jsxs("div", __assign$2({ className: clsx('treeview-file-label') }, { children: [jsxRuntime.exports.jsx("span", __assign$2({ className: 'treeview-file-label-icon ' }, { children: icon ? iconClone : jsxRuntime.exports.jsx(AiOutlineFile, { className: 'treeview-icons' }) })), jsxRuntime.exports.jsx("span", __assign$2({ className: 'treeview-file-label-name' }, { children: name }))] }))] })));
});

...
var useTree = () => useContext(TreeContext);
...
var Folder = React3.memo(
  ({ children, name, open, defaultOpen = false }) => {
    ...
    return /* @__PURE__ */ React3.createElement(TreeContextProvider, {
      value: 1 + depth
    ...
    }, open || isOpen ? /* @__PURE__ */ React3.createElement(AiOutlineMinusSquare, {
      className: "align-middle"
    }) : /* @__PURE__ */ React3.createElement(AiOutlinePlusSquare, null)), /* @__PURE__ */ React3.createElement("span", {
      className: "treeview-folder-label-icon"
    }, /* @__PURE__ */ React3.createElement(BsFolder, {
      className: "treeview-icons"
    })), /* @__PURE__ */ React3.createElement("span", {
      className: "treeview-folder-label-name"
    }, name))), /* @__PURE__ */ React3.createElement(AnimatePresence, null, open || isOpen && /* @__PURE__ */ React3.createElement(motion.ul, {
      initial: { height: 0 },
      animate: { height: "auto" },
      exit: { height: 0 },
...
var File = React3.memo(
  ({ name, active, isSelected, icon }) => {
    const depth = useTree();
    const ref = React3.useRef(null);
    const [selected] = React3.useState(isSelected);
    const { focusProps, isFocusVisible } = $f7dceffc5ad7768b$export$4e328f61c538687f();
    let iconClone;
    if (icon) {
      iconClone = React3.cloneElement(icon, {
        className: "treeview-icons"
      });
    }
    ...
    }, icon ? iconClone : /* @__PURE__ */ React3.createElement(AiOutlineFile, {
      className: "treeview-icons"
    })), /* @__PURE__ */ React3.createElement("span", {
